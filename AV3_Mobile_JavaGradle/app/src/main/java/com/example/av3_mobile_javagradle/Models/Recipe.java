package com.example.av3_mobile_javagradle.Models;
...
public class Recipe {
    ...
    public boolean veryHelthy;
    public boolean cheap;
    public boolean veryPopular;
    public boolean sustainable;
    public int weigthtWatcherSmartPoints;
    public String gaps;
    public boolean lowFoodMap;
